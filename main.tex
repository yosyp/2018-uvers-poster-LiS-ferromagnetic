...
\title{Ferromagnetic Nanoparticle-Assisted Polysulfide Trapping for
  Enhanced Lithium-Sulfur Battery} % Poster title

\author{Zan Gao, Yosyp Schwab, Yunya Zhang, Ningning Song, and
  Xiaodong Li} % Author(s)

\institute{Department of Mechanical and Aerospace Engineering,
  University of Virginia} % Institution(s)
